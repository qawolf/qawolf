...
## [v0.12.0](https://github.com/qawolf/qawolf/compare/v0.9.3...v0.12.0) - 2020-03-12

- 🍦QA Wolf creates vanilla Playwright tests that run lightning fast⚡. This slimmed down and simplified our API.

- ✨You can edit an existing test or run preparation steps with qawolf.create(). https://docs.qawolf.com/docs/add_steps_to_existing_tests

- 🔑Sign in once with the browser and run the rest of your tests logged in, in parallel. https://docs.qawolf.com/docs/handle_sign_in

- 🎥Record video artifacts for headless and headed modes, locally and in CI
...
- prefix env variables with QAW\_ [`#61`](https://github.com/qawolf/qawolf/issues/61)
