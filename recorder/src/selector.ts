import { buildCues, buildCuesForElement, Cue, getCueTypesConfig } from "./cues";
    ...
    targetGroup = getClickableGroup(
      ...
      (element: HTMLElement, depth: number) => {
        ...
        if (depth === 0) {
          ...
          const { cues: parentCues } =
            cuesByTarget.get(element.parentElement) || {};
          elementCues = [
