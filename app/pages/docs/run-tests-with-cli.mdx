...
**Warning: the above example is just an illustration. You should actually store your QA Wolf API key as a secret in your CI provider.** For example, in GitHub Actions you would <ExternalLink href="https://docs.github.com/en/actions/reference/encrypted-secrets#creating-encrypted-secrets-for-an-organization">create an encrypted secret</ExternalLink>:
