...
<Video youTubeId="WLj9tY7orLw" />

<SubHeader>Create an Environment Variable</SubHeader>

Each group in QA Wolf has its own set of environment variables.

You can access a group's environment variables by clicking the wrench icon next to the group name. You can do this from the test editor or from the dashboard.
...
Clicking on the wrench icon opens a popup where you can manage environment variables.
