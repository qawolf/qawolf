...
QA Wolf lets you share code between all tests for your team. A common use case for this is handling authentication. For example, you may have code to set a token in local storage:
