...
<SubHeader>Get Email Address</SubHeader>
...
Now let's use the email address in your test.

In the example below, we 1) get an email address, 2) fill out the sign form, and 3) get the login code from the email subject line.
