...
QA Wolf plays nicely with <a href="https://vercel.com/" target="_blank">Vercel</a> deployments. In this tutorial, we'll set up our tests to run when Vercel <a href="https://vercel.com/docs/platform/deployments" target="_blank">deploys</a> our site. This helps ensure our critical workflows don't break when we make changes.
...
Press the "Save" button to complete the Vercel integration. 🎉
