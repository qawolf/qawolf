...
- [after]&nbsp(Date): Find a message sent after this date. Default: When `getInbox` was called
- [timeout]&nbsp(number): Time in milliseconds to wait for a message. Default: `60000`
