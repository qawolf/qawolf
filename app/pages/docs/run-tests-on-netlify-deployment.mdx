...
QA Wolf will also create a comment on pull requests reflecting the most recent test suite. As your tests run, the comment is updated to report the latest results.
