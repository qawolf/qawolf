...
By default, this blocks google analytics and tag manager tracking to prevent your tests from interfering with your analytics. <a className="open-intercom">Message us</a> if you are using another analytics provider and we will block them too.
...
- [args] (Array<string\>): Arguments to pass to the browser launch. Useful for testing the camera.
- [browser] ("chromium" | "firefox" | "webkit"): Type of browser to launch. Default: "chromium".
- [devtools] (boolean): Open devtools. Default: false.
- [permissions] (Array<string\>): Accept <Playwright permission /> prompts. Default: none.
