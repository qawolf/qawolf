...
Enter the URL you want to test in the popup. In our example, we'll create a test on <a href='http://todomvc.com/examples/react' target="_blank">TodoMVC</a>. Then click the "Create test" button to create your test.
