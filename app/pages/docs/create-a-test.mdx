...
Snippets are pieces of code where you choose the element selector, as well as the action to
take on that element. Examples of supported actions include making an assertion,
uploading an image, and receiving an email.
