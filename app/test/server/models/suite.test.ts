...
describe("buildGitUrls", () => {
  ...
  it("returns urls for commit without pull request", () => {
    expect(
      ...
      commit_url:
        "https://github.com/qawolf/example/commit/eff58eea5c2d5743f0cf924aa3cefac639efc0f9",
  ...
  it("returns urls for commit with pull request", () => {
    expect(
      ...
      commit_url:
        "https://github.com/qawolf/example/pull/123/commits/eff58eea5c2d5743f0cf924aa3cefac639efc0f9",
...
describe("createSuiteForTrigger", () => {
  ...
  it("returns null if no enabled tests", async () => {
    const result = await createSuiteForTrigger({ trigger: trigger2 }, options);
