...
- [Use qawolf.config.js](api/config) to configure QA Wolf
...
<YouTubeVideo src="https://www.youtube.com/embed/e8tfR1Ey9DI" />
...
See the guide on [configuring QA Wolf](config) to learn more.
...
See [qawolf.config.js](api/config) to learn how to use TypeScript, change the test directory, replace the default template and more!
