...
QA Wolf provides CLI commands to [create browser tests ✅](quick_start#-record-a-browser-test), [create browser scripts 🤖](quick_start#-record-a-browser-script), and [set up CI ☁️](#set_up_ci).
...
Create a browser [test ✅](quick_start#-record-a-browser-test) or [script 🤖](quick_start#-record-a-browser-script).
