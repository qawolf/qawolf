...
```bash
QAW_ATTRIBUTE=my-data-attribute npx qawolf create www.myawesomesite.com
```

This will use the `my-data-attribute` [attribute](api#qaw_attribute) as a selector when possible.
