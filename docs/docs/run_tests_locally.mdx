...
Let's run our test to confirm it works locally. In the command line, run the following [command](api/cli#npx-qawolf-test-name). If applicable, replace `myFirstTest` with your test name.
